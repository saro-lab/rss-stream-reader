...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("RSS Stream Reader")
                description.set("RSS Stream Reader by SARO")
                ...
                scm {
                    connection.set("scm:git:git://github.com/saro-lab/rss-stream-reader.git")
                    developerConnection.set("scm:git:git@github.com:saro-lab/rss-stream-reader.git")
                    url.set("https://github.com/saro-lab/rss-stream-reader")
                }
            }
        }
    }
